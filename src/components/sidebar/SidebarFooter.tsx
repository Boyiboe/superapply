...
export function SidebarFooter() {
  return (
    <Footer className="p-2 flex justify-center">
      {/* 外层 ul 限宽，collapsed left 16px 对齐 */}
      <SidebarMenu className="w-full flex items-center group-data-[state=collapsed]:justify-start group-data-[state=collapsed]:pl-4 group-data-[state=collapsed]:max-w-[48px] group-data-[state=collapsed]:w-12 mx-auto">
        <SidebarMenuItem className="w-full group-data-[state=collapsed]:max-w-[48px] group-data-[state=collapsed]:w-12 group-data-[state=collapsed]:mx-0">
          <SidebarMenuButton
            ...
            className="
              w-full
              max-w-[200px]
              group-data-[state=collapsed]:max-w-[48px] group-data-[state=collapsed]:w-12 group-data-[state=collapsed]:h-12 group-data-[state=collapsed]:p-0 group-data-[state=collapsed]:mx-0
            "
          >
            <Link
              to="/profile"
